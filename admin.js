...
function loadProducts() {
    ...
    if (stored) {
        ...
        productsData = [];
        const prices = [2,194,313,157,392,150,180,600,491,431,492,326,265,409,616,627,512,585,332,621,433,253,452,488,226,139,520,250,459,125,339,334,124,552,191,490,220,615,308,556,323,137,403,631,0];
        for (let i = 1; i <= 45; i++) {
            productsData.push({
                id: i,
                name: "Available",
